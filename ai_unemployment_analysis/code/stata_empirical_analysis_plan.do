...
capture program drop descriptive_graphs_for_loaded_sample
program define descriptive_graphs_for_loaded_sample
...
program define run_descriptives
    use "$STDTA\panel_total_cno4.dta", clear
    descriptive_graphs_for_loaded_sample, sample("total_cno4") subgroup("all") tag("total_cno4")

    use "$STDTA\panel_province_cno4.dta", clear
    descriptive_graphs_for_loaded_sample, sample("province_cno4") subgroup("all") tag("province_cno4")
